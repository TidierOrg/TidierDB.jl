...
athlete_events = CSV.read("olympics_csv/athlete_events.csv", DataFrame)
noc_regions = CSV.read("olympics_csv/noc_regions.csv", DataFrame)


db = SQLite.DB() 
SQLite.load!(athlete_events, db, "athlete_events")
SQLite.load!(noc_regions, db, "noc_regions")
